          ...
          <div className="border-t border-line">
            {services.map((service, i) => {
              ...
              return (
                ...
                {service.id === "mobile" ? (
                  <div className="grid scroll-mt-28 gap-x-14 gap-y-8 border-b border-line py-[clamp(3rem,6vw,5.5rem)] lg:grid-cols-12">
                    <Reveal className="lg:col-span-5">
                      <div className="flex items-center gap-4">
                        <span className="label-mono text-accent-lift">Imagery</span>
                        <span aria-hidden="true" className="h-px w-10 bg-line-hard" />
                      </div>
                      <h2 className="display-lg mt-6 max-w-[14ch] text-chalk">
                    ...
                    <div className="lg:col-span-7">
                      <Reveal delay={100}>
                        <p className="max-w-[48ch] text-[1.125rem] leading-relaxed text-chalk">
                          Great imagery makes a site. If you don&rsquo;t have professional
                          photos, we make the most of what you&rsquo;ve got.
                        </p>
                      </Reveal>
                      ...
                      <Reveal delay={220}>
                        <p className="mt-7 max-w-[48ch] text-[0.9375rem] leading-relaxed text-dim">
                          Your products, your work, and your results are always shown as
                          they really are.
                        </p>
                      </Reveal>
                    </div>
